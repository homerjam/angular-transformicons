	  ...
	  angular.module('hj.transformicons').directive(transformicon.name, function () {
	    return {
	      ...
	      link: function link($scope, $element) {
	        ...
	        $scope.$watch('bindTransform', function (transform) {
	          if (transform === true) {
